...
{ m: "SUBROUTINE ENVEL", span: 1, t: "The outer zone.",
  b: "The role of Vardya’s atmosphere program: given total R and L, the outermost layers follow the blanketed radiative T–τ relation of Henyey, Vardya & Bodenheimer (1965), integrated in optical depth to the onset of convection; from there the march continues in column mass, through the superadiabatic layer, down to the fitting point at 0.2 percent of the mass." },
{ m: "SUBROUTINE TTAU", span: 1, t: "The blanketed atmosphere.",
  b: "HVB (1965) eq. (10): the Böhm-Vitense gray law with its e-folding correction, plus the line-blanketing terms A − Be⁻³⁰ᵗ of eqs. (11)–(12), scaled by ζ, the square root of the metal-to-hydrogen ratio relative to solar (eq. 9). This is the layer whose absence kept the reconstructed Sun 25 percent too compact — Henyey’s group needed a separate paper for exactly this physics, and the reconstruction rediscovered why." },
