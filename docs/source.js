...
{ m: "SUBROUTINE STATE", span: 1, t: "The equation of state.",
  b: "Ideal fully ionized gas plus radiation. The 1964 production code already carried degeneracy (BFGH 1965, Appendix A); its restoration is the next chapter of this reconstruction." },
{ m: "CHMLG=", span: 3, t: "H⁻ in logarithms.",
  b: "The H⁻ opacity is evaluated as a logarithm to dodge single-precision overflow, then joined harmonically to Kramers and electron scattering — the join keeps κ and its derivatives continuous, as Newton requires." },
